...
async function initializeDepartmentPage() {
...
async function getDepartmentList() {
    ...
    try {
        ...
        return Array.isArray(result.departments)
            ? result.departments
            : [];
...
async function createDepartmentAPI(departmentData) {
...
async function updateDepartmentStatistics() {
