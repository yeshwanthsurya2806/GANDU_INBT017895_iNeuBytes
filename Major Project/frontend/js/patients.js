...
function editPatient(id) {
    ...
    /*
     * Department is not currently stored
     * in the patients database schema.
     */
...
async function handlePatientSubmit(
     ...
     * =====================================================
     *
     * We are NOT changing Edit yet.
     * It will be connected to SQLite separately.
     */
    ...
    try {
        ...
        showToast(
            "Patient Added",
            "Patient has been added to the database successfully.",
            "success"
        );
         ...
         * login password for the patient.
         */
...
async function confirmDeletePatient() {
    ...
    try {
        ...
        const response =
            await fetch(
                `/api/admin/patients/${patientToDelete}`,
                {
